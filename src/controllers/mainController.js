// Module fs required, because we need use read the json file.
const fs = require("fs");
// Module path required, because we need use the whole path to json file.
const path = require("path");

// Through the lines below we are reading the data into json file.
...
module.exports = {
  ...
  index: (req, res) => {
    ...
    res.render("home", { seen: visited, insale: sale });
  },
};
